...
---
```{r}
#un fichier code est donner dans un autre fichier, il existe car les exercice 1 et 3 parfoit ne se lance pas klorsque l'on knit le fichier rmd, si se probleme se reproduit j'ai copier le code et placer dans un fichier R qui permet d'afficher les graphiques. 
```
